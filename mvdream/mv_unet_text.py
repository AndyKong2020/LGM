...
class CondSequential(nn.Sequential):
    ...
    def forward(self, x, emb, context=None, num_frames=1):
        for layer in self:
            ...
            if isinstance(layer, ResBlock) or layer_type == "ResBlock":
                x = layer(x, emb)
            elif isinstance(layer, SpatialTransformer3D) or layer_type == "SpatialTransformer3D":
